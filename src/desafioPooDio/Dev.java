...
public class Dev {
    ...
    public void progredir() {
        ...
        if (conteudo.isPresent()) {
            ...
            System.err.println("Você não está matriculado em nenhum conteudo desse bootcamp");
        }

    }

    public double calcularTotalXp() {
        return this.conteudosConcluidos.stream().mapToDouble(conteudo -> conteudo.calcularXp()).sum(); // lambda
        // return
